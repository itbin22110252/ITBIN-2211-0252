...
private int customerPk = 0;
   ...
   /**
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 720, 80, -1));
        ...
        jPanel1.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 720, 80, -1));
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(1430, 720, 80, -1));
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 790, 140, -1));
        ...
        jPanel1.add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 720, 80, -1));
...
String name = txtName.getText();
    if (validateFields()) {
        ...
        if (CustomerController.addCategory(name)) {
            setVisible(false);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(validateFields()){
            ...
            try{
                ...
                ps.executeUpdate();
                JOptionPane.showMessageDialog(null,"Customer updateded successfully");
                setVisible(false);
                new ManageCustomer().setVisible(true);
