...
public class ManageOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel22.setIcon(new javax.swing.ImageIcon("D:\\Inventory Management System\\Icon\\clipart543962.png")); // NOI18N
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(1740, 960, -1, -1));
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if (!noOfUnits.isEmpty()) {
            ...
            int noOfUnitsInt = Integer.parseInt(noOfUnits);

            boolean isInStock = CartController.checkStock(productPk, noOfUnitsInt);
            if (isInStock) {
                DefaultTableModel model = (DefaultTableModel) tableCart.getModel();
                boolean addedToCart = CartController.addProductToCart(model, productPk, productName, noOfUnits, productPrice, productDescription, totalPrice);
                if (addedToCart) {
            ...
            JOptionPane.showMessageDialog(null, "Number of units and product fields are required");
        }
