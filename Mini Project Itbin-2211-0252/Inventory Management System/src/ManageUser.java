...
public class ManageUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 750, 140, -1));
        ...
        jPanel1.add(txtAppUserPk, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 710, 430, -1));
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 760, 100, -1));

        jLabel16.setIcon(new javax.swing.ImageIcon("D:\\Inventory Management System\\Icon\\clipart543962.png")); // NOI18N
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 760, -1, -1));
    ...
    if (validateFields("edit")) {
        ...
        try {
            ...
            if (rowsAffected > 0) {
                ...
                JOptionPane.showMessageDialog(null, "User not found or failed to update");
            }
        } catch (Exception e) {
  ...
  String appuserpkStr = txtAppUserPk.getText();
    if (appuserpkStr.isEmpty()) {
        ...
        try {
            ...
            if (confirmation == JOptionPane.YES_OPTION) {
                boolean deleted = UserController.deleteUser(appuserpk);
                if (deleted) {
                    JOptionPane.showMessageDialog(null, "User deleted successfully");
                } else {
                    JOptionPane.showMessageDialog(null, "User not found or failed to delete");
                }
                setVisible(false);
                new ManageUser().setVisible(true);
            }
